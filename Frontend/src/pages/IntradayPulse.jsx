    ...
    return (
        <div className="bg-white min-h-screen font-sans selection:bg-orange-100 selection:text-orange-900">
            ...
            <FeatureLock featureName="Live Momentum" description="Unlock real-time institutional signals and deep quant logic analysis.">
                ...
                {/* Performance Banner */}
                <section className="py-24 bg-slate-900 mx-6 rounded-[80px] mb-24 overflow-hidden relative shadow-2xl shadow-orange-900/20">
                    <div className="absolute top-0 right-0 w-[1000px] h-[1000px] bg-orange-600/10 blur-[150px] rounded-full -mr-96 -mt-96" />
                    <div className="max-w-7xl mx-auto px-12 relative z-10">
                        <div className="flex flex-col md:flex-row items-center justify-between gap-16">
                            <div className="max-w-xl">
                                <h2 className="text-5xl font-black text-white mb-8 leading-tight tracking-tighter">Institutional Speed. <br/><span className="text-orange-500 italic font-medium">No Compromises.</span></h2>
                                ...
                                <div className="grid grid-cols-2 gap-12">
                                    <div>
                                        ...
                                        <p className="text-[10px] font-black text-orange-500 uppercase tracking-widest">Global Latency</p>
                                    </div>
                                    <div>
                                        <p className="text-4xl font-black text-white tracking-tighter mb-2">5,400+</p>
                                        <p className="text-[10px] font-black text-orange-500 uppercase tracking-widest">Assets Monitored</p>
                                    </div>
                                </div>
                            </div>
                            <div className="w-full md:w-[500px] aspect-square rounded-[60px] bg-white/5 backdrop-blur-3xl border border-white/10 p-12 flex flex-col justify-between">
                                ...
                                <div className="space-y-4">
                                    <div className="h-2 w-full bg-white/10 rounded-full overflow-hidden">
                                        <div className="h-full w-3/4 bg-orange-600" />
                                    </div>
                                    <div className="h-2 w-full bg-white/10 rounded-full overflow-hidden">
