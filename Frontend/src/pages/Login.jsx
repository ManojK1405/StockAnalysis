  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#03060b] p-6 font-outfit overflow-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-fuchsia-600/10 blur-[150px] rounded-full mix-blend-screen" />
      </div>
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-white tracking-tight">System Portal</h1>
          <p className="text-slate-400 text-sm mt-3 font-medium tracking-wide">Authenticate to access live market streams</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                placeholder="operative@terminal.com"
          ...
          >
            ...
            {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : (
              <>
                <span className="tracking-wide">Initialize Link</span>
        ...
        <p className="text-center text-slate-500 text-sm mt-10 font-medium">
          Unregistered operative? <Link to="/signup" className="text-blue-400 hover:text-blue-300 font-bold ml-1 transition-colors">Request Access</Link>
        </p>
      </motion.div>
    </div>
  );
